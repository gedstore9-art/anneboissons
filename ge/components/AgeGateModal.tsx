      ...
      <div className="max-w-md w-full bg-zinc-900 border border-amber-500/40 rounded-2xl p-8 text-center shadow-[0_0_50px_rgba(212,175,55,0.2)]">
        ...
        {!refused ? (
          <>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full py-3.5 bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700 text-black font-bold uppercase tracking-wider rounded-xl transition shadow-lg"
              >
          ...
          <div className="py-4">
            ...
            <p className="text-zinc-400 text-sm mb-6">
              Conformément à la législation béninoise, ce catalogue est inaccessible aux mineurs.
            </p>
            <a
              href="https://www.google.com"
              className="inline-block px-6 py-2 bg-zinc-800 hover:bg-zinc-700 text-white rounded-lg text-sm"
            >
              Quitter le site
            </a>
          </div>
